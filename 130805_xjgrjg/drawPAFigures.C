...
/*  
  ...
  */
  ...
  for ( int icent = 1 ; icent<=nCentBinPa  ; icent++) { 
    ...
    fff[iSpecies][iglb] = new TFile("ffFiles/photonTrackCorr_ppbDATA_output_photonPtThr60_to_9999_jetPtThr30_20130805_genLevel0_qnch0.root");
  ...
  makeMultiPanelCanvas(cDphi,3,1,0.0,0.0,0.2,0.15,0.02);
  for ( int icent = 1 ; icent<=nCentBinPa  ; icent++) {
    cDphi->cd(icent);
