...
void drawPtDependence() {
  
  const int nPtBin = 3;
  double ptBin[nPtBin+1] = {50,60,80,9999}; 
  ...
  for ( int ipt = 0 ; ipt<nPtBin  ; ipt++) { 
    ...
    //  int icent = 7;
    // fff[iSpecies][iglb] = new TFile(Form("ffFiles/photonTrackCorr_ppDATA_output_photonPtThr%d_to_%d_jetPtThr30_20130724_genLevel0_qnch0.root",(int)ptBin[ipt],(int)ptBin[ipt+1]));
      int icent = 10030;
      fff[iSpecies][iglb] = new TFile(Form("ffFiles/photonTrackCorr_pbpbDATA_output_photonPtThr%d_to_%d_jetPtThr30_20130724_genLevel0_qnch0.root",(int)ptBin[ipt],(int)ptBin[ipt+1]));
