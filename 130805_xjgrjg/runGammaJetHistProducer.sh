...
#pPb data
#root -l -b -q 'gammaJetHistProducer.C+(4, 60,9999, 30, 1, 0, 0)'
#root -l -b -q 'gammaJetHistProducer.C+(4, 60,9999, 30, 2, 0, 0)'
#root -l -b -q 'gammaJetHistProducer.C+(4, 60,9999, 30, 3, 0, 0)'
#root -l -b -q 'gammaJetHistProducer.C+(4, 60,9999, 30, 4, 0, 0)'
#root -l -b -q 'gammaJetHistProducer.C+(4, 60,9999, 30, 5, 0, 0)'

#yeonju, pt cut dependence

root -l  'gammaJetHistProducer.C+(4, 50, 60, 30, 1, 0, 0)'
root -l  'gammaJetHistProducer.C+(4, 60, 80, 30, 1, 0, 0)'
root -l  'gammaJetHistProducer.C+(4, 80, 9999, 30, 1, 0, 0)'

root -l  'gammaJetHistProducer.C+(4, 50, 60, 30, 2, 0, 0)'
root -l  'gammaJetHistProducer.C+(4, 60, 80, 30, 2, 0, 0)'
root -l  'gammaJetHistProducer.C+(4, 80, 9999, 30, 2, 0, 0)'

root -l  'gammaJetHistProducer.C+(4, 50, 60, 30, 3, 0, 0)'
root -l  'gammaJetHistProducer.C+(4, 60, 80, 30, 3, 0, 0)'
root -l  'gammaJetHistProducer.C+(4, 80, 9999, 30, 3, 0, 0)'
