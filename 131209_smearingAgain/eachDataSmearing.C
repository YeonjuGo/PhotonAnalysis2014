// if fixOpt ==1, C,N and S are NOT fixed. 
// if fixOpt ==0, C,N and S are fixed.  
// to find out that each PbPb and pp RECO are consistent with associated smearing GEN.
// yeonju 131211
...
//
    ...
    yJetpp -> Draw2(hphoton[0], "tgj.genPhotonEt", "", "");// pp 
    yJetpb -> Draw2(hphoton[1], "tgj.genPhotonEt", centCut1, "ptHatWeight");// PbPb 0-10%
    yJetpb -> Draw2(hphoton[2], "tgj.genPhotonEt", centCut2, "ptHatWeight");// PbPb 10-30%
    yJetpb -> Draw2(hphoton[3], "tgj.genPhotonEt", centCut3, "ptHatWeight");
    yJetpb -> Draw2(hphoton[4], "tgj.genPhotonEt", centCut4, "ptHatWeight");
...
//
    ...
    yJetpb -> Draw2(hGenPt[1], "refPt", centCut1, "ptHatWeight");
    yJetpb -> Draw2(hGenPt[2], "refPt", centCut2, "ptHatWeight");
    yJetpb -> Draw2(hGenPt[3], "refPt", centCut3, "ptHatWeight");
    yJetpb -> Draw2(hGenPt[4], "refPt", centCut4, "ptHatWeight");
...
//
    ...
    yJetpb -> Draw2(hRecoPt[1], "pt","refPt>0" && centCut1, "ptHatWeight");
    yJetpb -> Draw2(hRecoPt[2], "pt","refPt>0" && centCut2, "ptHatWeight");
    yJetpb -> Draw2(hRecoPt[3], "pt","refPt>0" && centCut3, "ptHatWeight");
    yJetpb -> Draw2(hRecoPt[4], "pt","refPt>0" && centCut4, "ptHatWeight");
