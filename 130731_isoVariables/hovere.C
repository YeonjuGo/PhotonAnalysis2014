...
void hovere()
{
    ...
    tgj -> Draw("hovere:hf4Sum>>hh", "(abs(vz) < 15) && (photonEt > 60 ) && ( abs(genMomId) <= 22 )","colz");
    hh -> GetXaxis() -> SetTitle("E_{T}^{HF|#eta|>4} (GeV)");
    hh -> GetYaxis() -> SetTitle("hovere");
...
//    hh -> GetZaxis() -> SetLabelOffset(0.1);
    ...
    meanHist -> GetYaxis() -> SetTitle("<hovere>");
    ...
    for(int i=0;i<10;i++){
        ...
        tgj -> Draw(Form("hovere>>hist%d",i), Form("(abs(tgj.vz) < 15) && (tgj.photonEt > 60 ) && ( abs(genMomId) <= 22 ) &&  (hf4Sum > %d*10 && hf4Sum < %d*10) ", i, i+1));
        hist[i] -> Draw();
    ...
    c2 -> cd();
    tgj -> Draw("hovere>>h", Form("(abs(tgj.vz) < 15) && (tgj.photonEt > 60 )  && ( abs(genMomId) <= 22 ) &&  (hf4Sum > %d && hf4Sum < %d) ", low, high));
    c1-> cd(3);
    h -> GetXaxis() -> SetTitle("E_{T}^{HF|#eta|>4} (GeV)");
    gPad-> SetLogy();
    h -> Draw();
    ...
    c2 -> cd();
    tgj -> Draw("hovere>>h2", Form("(abs(tgj.vz) < 15) && (tgj.photonEt > 60 )  && ( abs(genMomId) <= 22 ) &&  (hf4Sum > %d && hf4Sum < %d) ", low, high));
    h2 -> SetLineColor(2);
    c1-> cd(3);
    h2 -> Draw("same");
    ...
    c2 -> cd();
    tgj -> Draw("hovere>>h3", Form("(abs(tgj.vz) < 15) && (tgj.photonEt > 60 )  && ( abs(genMomId) <= 22 ) &&  (hf4Sum > %d && hf4Sum < %d) ", low, high));
    h3 -> SetLineColor(3);
    c1-> cd(3);
    h3 -> Draw("same");
    ...
    c2 -> cd();
    tgj -> Draw("hovere>>h4", Form("(abs(tgj.vz) < 15) && (tgj.photonEt > 60 ) && ( abs(genMomId) <= 22 ) &&  (hf4Sum > %d && hf4Sum < %d) ", low, high));
    h4 -> SetLineColor(4);
    c1-> cd(3);
    h4 -> Draw("same");
    ...
    c2 -> cd();
    tgj -> Draw("hovere>>h5", Form("(abs(tgj.vz) < 15) && (tgj.photonEt > 60 ) && ( abs(genMomId) <= 22 ) &&  (hf4Sum > %d && hf4Sum < %d) ", low, high));
    h5 -> SetLineColor(5);
    c1-> cd(3);
    h5 -> Draw("same");
